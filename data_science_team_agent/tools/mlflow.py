...
def create_mlflow_experiment(
    ...
    try:
        ...
        error_message = f"Error creating MLflow experiment: {str(e)}"
...
def log_experiment_to_mlflow(
    ...
    try:
        ...
        error_message = f"Error logging to MLflow: {str(e)}"
        return error_message, {"error": error_message}
...
def get_mlflow_run_info(
    ...
    try:
        ...
        error_message = f"Error getting MLflow run info: {str(e)}"
        return error_message, {"error": error_message}
...
def list_mlflow_experiments(
    ...
    try:
        ...
        error_message = f"Error listing MLflow experiments: {str(e)}"
        return error_message, {"error": error_message}
...
def log_model_to_mlflow(
    ...
    try:
        ...
        error_message = f"Error logging model to MLflow: {str(e)}"
        return error_message, {"error": error_message}
