...
class DataCleaningAgent(BaseAgent):
    ...
    def __init__(
        ...
        Args:
            ...
            file_name: Name of the output file. Defaults to "data_cleaner.py".
            function_name: Name of the function. Defaults to "data_cleaner".
    ...
    def invoke_agent(
        ...
        **kwargs,
        ...
        Args:
            data_raw: Raw pandas DataFrame to clean.
...
def make_data_cleaning_agent(  # noqa: C901 - complex agent setup is intentional
    model,
    n_samples=30,
    log=False,
    log_path=None,
    ...
    Returns:
        Compiled data cleaning agent graph.
    ...
    def execute_data_cleaner_code(state: GraphState):
        ...
        if error is None:
            try:
                ...
                added_cols = sorted(cols_after - cols_before)
                dtype_changes = []
        ...
        error_prefixed = f"An error occurred during data cleaning: {validation_error}" if validation_error else None
        ...
        return {
            "data_cleaned": df_out.to_dict() if error_prefixed is None and df_out is not None else None,
